defmodule Vampire_Number do
	...
	def check(current_number) do
              ...
              checkk(current_number)
		 
	    
	end
        
        def checkk(current_number) do
        ...
        def check1(current_number) do
           {:ok,pid} = Vampire_Number.start_link()
           GenServer.call(pid,{:check,current_number})
        end
...
#current_number = 1260
Enum.each(current_number1..current_number2, &Vampire_Number.check1/1)
